		...
		html : {
			...
			data : `
				...
				<form name="my-cool-form">
					...
					<s-recaptcha for="my-captcha" sitekey="6Ld4DmAUAAAAAGFPqTFuTAwhb9xClISGJStNPQR5"></s-recaptcha>
					<s-validator for="my-captcha"></s-validator>

					<input type="checkbox" name="my-captcha-2" style="display:none" required />
					<s-recaptcha class="m-t" theme="dark" for="my-captcha-2" sitekey="6Ld4DmAUAAAAAGFPqTFuTAwhb9xClISGJStNPQR5"></s-recaptcha>
